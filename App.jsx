    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="Cadastro" screenOptions={{
                ...
                headerTintColor: '#e4e1dc',
                headerTitleStyle: {
                    fontWeight: 'bold',
                }
            }}>
                <Stack.Screen name="Cadastro" options={{ title: 'MEETING ENTERPRISES' }}>
                    {props => (
                        <ScrollView contentContainerStyle={styles.scroll}>
                            <View style={styles.section}>
                                ...
                                <TouchableOpacity style={styles.button} onPress={() => props.navigation.navigate('Fornecedores')}>
                                    <Text style={styles.buttonText}>MEETING SUPPLIERS</Text>
                                </TouchableOpacity>
                            </View>
                        </ScrollView>
                    )}
                </Stack.Screen>
                <Stack.Screen name="Fornecedores" options={{ title: 'MEETING SUPPLIERS' }}>
